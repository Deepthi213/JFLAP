...
public class MooreMachine extends MealyMachine 
{
    ...
    private Map<TextLabel, String> myTextLabelMap;
    ...
    public void setOutput(TextLabel textLabel, String output)
    {
        /*
         * The null check occurs here but the input string can also
         * be checked before.
         */
        if(output == null)
            myTextLabelMap.put(textLabel, "");
        else
            myTextLabelMap.put(textLabel, output);
    }
