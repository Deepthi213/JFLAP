...
public class SaveAsAction extends RestrictedAction {
	 ...
	 */
	public SaveAsAction(Environment environment, NewAction newAction) {
		super("Save As...", null);
	...
	public void actionPerformed(ActionEvent event) {
		...
		if (environment.getFile().getName() != null) {
			newaction.DIALOG.setTitle(newaction.DEFAULT_TITLE+" ("+newaction.titleName(environment.getObject())+") <"+environment.getFile().getName().toString()+">");		
