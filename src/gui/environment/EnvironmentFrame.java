...
public class EnvironmentFrame extends JFrame {
	...
	public EnvironmentFrame(Environment environment) {
		...
		environment.addFileChangeListener(new FileChangeListener() {
			public void fileChanged(FileChangeEvent e) {
				refreshTitle(environment.getObject());
			}
		});
		initMenuBar();
	...
	protected void refreshTitle(Serializable object) {
		//System.out.println("object.getClass().getSimpleName() : " + object.getClass().getSimpleName());
		String title = DEFAULT_TITLE + " : (" + NewAction.titleName(object) + ") " + getDescription();
		setTitle(title);
	}
...
//                  Get the suggested file name.
	...
	public boolean closeDirtyFrame() {
