...
public class SelectionDrawer extends AutomatonDrawer {
	...
	protected void drawTextLabels(Graphics g) {
		java.awt.Graphics2D g2 = (java.awt.Graphics2D) g;
		super.drawTextLabel(g);
		Iterator<Serializable> it = selectedTextLabels.iterator();
		while (it.hasNext()) {
			TextLabel t = (TextLabel) it.next();
			try {
	...
	private Set<Serializable> selectedTxt = new HashSet<>(), selectedTextLabels = new HashSet<>();
